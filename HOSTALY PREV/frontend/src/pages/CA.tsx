...
import { CurrencyDollarIcon, TrendingUpIcon, ChartBarIcon, CalendarIcon } from '@heroicons/react/24/outline';
    ...
    >
      ...
      <div className="bg-gradient-to-r from-hotaly-primary to-hotaly-primary-dark rounded-xl p-6 text-white">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">Module CA</h1>
            <p className="text-hotaly-neutral-light">Chiffre d'Affaires & Revenus</p>
          </div>
        </div>
      </div>
        ...
        <Card variant="elevated" className="hover:scale-105 transition-transform">
          <div className="text-center p-6">
            <div className="mx-auto w-12 h-12 bg-hotaly-secondary/20 rounded-full flex items-center justify-center mb-4">
              <TrendingUpIcon className="h-6 w-6 text-hotaly-secondary" />
            </div>
        ...
        <Card variant="elevated" className="hover:scale-105 transition-transform">
          <div className="text-center p-6">
            <div className="mx-auto w-12 h-12 bg-hotaly-accent/20 rounded-full flex items-center justify-center mb-4">
              <ChartBarIcon className="h-6 w-6 text-hotaly-accent" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">RevPAR</h3>
            <p className="text-gray-600 text-sm">Revenue Per Available Room</p>
            <div className="mt-4">
        ...
        <Card variant="elevated" className="hover:scale-105 transition-transform">
          <div className="text-center p-6">
            <div className="mx-auto w-12 h-12 bg-hotaly-tertiary/20 rounded-full flex items-center justify-center mb-4">
              <CalendarIcon className="h-6 w-6 text-hotaly-tertiary" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Taux d'Occupation</h3>
      ...
      <Card className="bg-gradient-to-r from-hotaly-neutral to-hotaly-neutral-light">
        <div className="text-center p-8">
          <div className="mx-auto w-16 h-16 bg-hotaly-primary/20 rounded-full flex items-center justify-center mb-4">
            <CurrencyDollarIcon className="h-8 w-8 text-hotaly-primary" />
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Module en Développement</h2>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Le module Chiffre d'Affaires (CA) est actuellement en cours de développement. 
            Il permettra de gérer les revenus, l'ADR, le RevPAR et tous les indicateurs 
            financiers de votre établissement hôtelier.
          </p>
